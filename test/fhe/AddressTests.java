...
public class AddressTests {
	...
	public void testEquals() {
		DeerhavenAddress addr1 = new DeerhavenAddress(2052, "California Ave", "7", "Provo");
		assertTrue(addr1.equals(new DeerhavenAddress(2052, "California Ave", "7", "Provo")));

		assertFalse(addr1.equals(null));
		assertFalse(addr1.equals("bogus"));
		assertFalse(addr1.equals(new DeerhavenAddress(0, "California Ave", "7", "Provo")));
		assertFalse(addr1.equals(new DeerhavenAddress(2052, "Bogus", "7", "Provo")));
		assertFalse(addr1.equals(new DeerhavenAddress(2052, "California Ave", "Bogus", "Provo")));
	}
	...
	public void testAddressConstructor() {
		...
		assertEquals(new DeerhavenAddress(2052, "California", "7", "Provo"), address);

		address = new DeerhavenAddress("1344 S 1500 E Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1344, "S 1500 E", null, "Provo"), address);

		address = new DeerhavenAddress("1436 S. State St. Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1436, "State", null, "Provo"), address);

		address = new DeerhavenAddress("1448 E 1370 S Provo, Utah");
		assertEquals(new DeerhavenAddress(1448, "E 1370 S", null, "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(1465, "E 1370 S", null, "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(1747, "Oregon", null, "Provo"), address);

		address = new DeerhavenAddress("1857 Nevada Ave Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1857, "Nevada", null, "Provo"), address);

		address = new DeerhavenAddress("1968 Washington Ave. Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1968, "Washington", null, "Provo"), address);

		address = new DeerhavenAddress("2022 Park Street Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2022, "Park", null, "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(2057, "Arizona", null, "Provo"), address);

		address = new DeerhavenAddress("2083 California Ave Apt C Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2083, "California", "C", "Provo"), address);

		address = new DeerhavenAddress("2144 Dakota Ave Apt A Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2144, "Dakota", "A", "Provo"), address);

		address = new DeerhavenAddress("2144 Nevada Ave #2 Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2144, "Nevada", "2", "Provo"), address);

		address = new DeerhavenAddress("2173 State St Apt 1 Provo, Utah 84606 ");
		assertEquals(new DeerhavenAddress(2173, "State", "1", "Provo"), address); // TODO
																									// what
																									// about
																									// South
																									// state?
		...
		assertEquals(new DeerhavenAddress(2416, "Tennessee", null, "Provo"), address);

		address = new DeerhavenAddress("1015 Canyon Meadow Dr #6");
		assertEquals(new DeerhavenAddress(1015, "Canyon Meadow", "6", "Provo"), address);

		address = new DeerhavenAddress("1015 Canyon Meadow Dr#6");
		assertEquals(new DeerhavenAddress(1015, "Canyon Meadow", "6", "Provo"), address);

		address = new DeerhavenAddress("1028 Canyon Vista Rd#7");
		assertEquals(new DeerhavenAddress(1028, "Canyon Vista", "7", "Provo"), address);
		...
		address = new DeerhavenAddress("1028 S Canyon Vista Dr #8"); // TODO Are
																		...
																		// same
																		// road?
		assertEquals(new DeerhavenAddress(1028, "Canyon Vista", "8", "Provo"), address);
		...
		address = new DeerhavenAddress("1034 S Canyon Meadow Dr #3"); // Compare
																		...
																		// Meadow
																		// Drive
		assertEquals(new DeerhavenAddress(1034, "Canyon Meadow", "3", "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(1068, "Canyon Meadow", "6", "Provo"), address);

		address = new DeerhavenAddress("1068 S. Canyon Meadow Dr #4");
		assertEquals(new DeerhavenAddress(1068, "Canyon Meadow", "4", "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(1077, "Canyon Meadow", "4", "Provo"), address);

		address = new DeerhavenAddress("1676 E 1080 S #6");
		assertEquals(new DeerhavenAddress(1676, "E 1080 S", "6", "Provo"), address);
		...
		assertEquals(new DeerhavenAddress(1145, "Meadow Fork", "1", "Provo"), address);
