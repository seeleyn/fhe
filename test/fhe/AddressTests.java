...
public class AddressTests {
	...
	public void testAddressConstructor() {
		...
		assertEquals(new DeerhavenAddress(2052,"California Ave","7","Provo","Utah","84606"), address);
		...
		assertEquals(new DeerhavenAddress(1436,"S State St",null,"Provo","Utah","84606"), address);
		...
		assertEquals(new DeerhavenAddress(1747,"Oregon Ave",null,"Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("1857 Nevada Ave Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1857,"Nevada Ave",null,"Provo","Utah","84606"), address);

		address = new DeerhavenAddress("1968 Washington Ave. Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(1968,"Washington Ave",null,"Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("2022 Park Street Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2022,"Park Street",null,"Provo","Utah","84606"), address);
		...
		assertEquals(new DeerhavenAddress(2057,"Arizona Ave",null,"Provo","Utah","84606"), address);

		address = new DeerhavenAddress("2083 California Ave Apt C Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2083,"California Ave","C","Provo","Utah","84606"), address);

		address = new DeerhavenAddress("2144 Dakota Ave Apt A Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2144,"Dakota Ave","A","Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("2144 Nevada Ave #2 Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2144,"Nevada Ave","2","Provo","Utah","84606"), address);

		address = new DeerhavenAddress("2173 State St Apt 1 Provo, Utah 84606 ");
		assertEquals(new DeerhavenAddress(2173,"State St","1","Provo","Utah","84606"), address);

		address = new DeerhavenAddress("2416 Tennessee Ave Provo, Utah 84606");
		assertEquals(new DeerhavenAddress(2416,"Tennessee Ave",null,"Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("1015 Canyon Meadow Dr #6");
		assertEquals(new DeerhavenAddress(1015,"Canyon Meadow Dr","6","Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("1015 Canyon Meadow Dr#6");
		assertEquals(new DeerhavenAddress(1015,"Canyon Meadow Dr","6","Provo","Utah","84606"), address);

		address = new DeerhavenAddress("1028 Canyon Vista Rd#7");
		assertEquals(new DeerhavenAddress(1028,"Canyon Vista Rd","7","Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("1028 S Canyon Vista Dr #8"); //TODO Are Canyon Vista Rd and S. Canyon Vista Dr the same road?
		assertEquals(new DeerhavenAddress(1028,"S Canyon Vista Dr","8","Provo","Utah","84606"), address);
		
		address = new DeerhavenAddress("1034 S Canyon Meadow Dr #3"); // Compare with just Canyon Meadow or Canyon Meadow Drive
		assertEquals(new DeerhavenAddress(1034,"S Canyon Meadow Dr","3","Provo","Utah","84606"), address);
